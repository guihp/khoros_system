...
export const categories: Category[] = [
  ...
  },
  {
    ...
    description:
      "A sensação de não ser bom o suficiente e como lidar com ela.",
  ...
  },
  {
    ...
    name: "Autoestima",
    description:
      "Construir uma relação mais gentil e realista consigo mesmo.",
  ...
  },
  {
    ...
    description:
      "Cuidados diários para uma vida emocional mais equilibrada.",
